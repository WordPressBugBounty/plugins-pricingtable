...
?>
<style type="text/css">
	.pricingtable-<?php echo esc_attr($post_id) . " .column-item-data.odd"; ?> {
		<?php if (!empty($pricingtable_row_bg_odd)): ?>background: <?php echo esc_attr($pricingtable_row_bg_odd); ?>;
		<?php endif; ?>
	}

	.pricingtable-<?php echo esc_attr($post_id) . " .column-item-data.even"; ?> {
		<?php if (!empty($pricingtable_row_bg_even)): ?>background: <?php echo esc_attr($pricingtable_row_bg_even); ?>;
		<?php endif; ?>
	}
</style>

<div class="pricingtable   pricingtable-<?php echo esc_attr($post_id); ?> <?php echo esc_attr($pricingtable_themes); ?>" style="background:url(<?php echo esc_url($pricingtable_bg_img); ?>) repeat scroll 0 0 rgba(0, 0, 0, 0);">
	...
	?><div style="width:<?php echo esc_attr($pricingtable_column_width[$j]); ?>;margin:<?php echo esc_attr($pricingtable_column_margin[$j]); ?> " class="column column-<?php echo esc_attr($j); ?> <?php echo esc_attr($pricingtable_featured); ?>">
			...
			?>
				<span class="pricingtable-ribbon <?php echo esc_attr($column_ribbon_position[$j]); ?> ribbon-<?php echo esc_attr($pricingtable_column_ribbon[$j]); ?>"></span>
				<?php
			}
