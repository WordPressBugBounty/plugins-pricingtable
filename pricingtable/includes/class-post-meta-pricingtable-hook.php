...
function pricingtable_metabox_content_shortcode($post_id){
    ...
    <div class="section">
        ...
        <div class="copy-to-clipboard">
            <input type="text" value="[pricingtable id='<?php echo esc_attr($post_id);  ?>']"> <span class="copied">Copied</span>
            <p class="description">You can use this shortcode under post content</p>
        </div>

        <div class="copy-to-clipboard">
            To avoid conflict:<br>
            <input type="text" value="[pricingtable_pickplugins id='<?php echo esc_attr($post_id);  ?>']"> <span class="copied">Copied</span>
        ...
        <div class="copy-to-clipboard">
            <textarea cols="50" rows="1" onClick="this.select();" ><?php echo '<?php echo do_shortcode("[pricingtable id='; echo "'".esc_attr($post_id)."']"; echo '"); ?>'; ?></textarea> <span class="copied">Copied</span>
            <p class="description">PHP Code, you can use under theme .php files.</p>
        </div>

        <div class="copy-to-clipboard">
            <textarea cols="50" rows="1" onClick="this.select();" ><?php echo '<?php echo do_shortcode("[pricingtable_pickplugins id='; echo "'".esc_attr($post_id)."']"; echo '"); ?>'; ?></textarea> <span class="copied">Copied</span>
...
function pricingtable_metabox_content_table_data($post_id){
    ...
    <div class="pricingtable_admin_cell">
        <table id="pricingtable_admin" border="0" post_id="<?php echo esc_attr($post_id); ?>">
            <?php
            for($j=1; $j<=$pricingtable_total_row; $j++){
                if($j==1){
                    ?>
                    <tr class='row-header pricingtable_admin_tr_<?php echo esc_attr($j); ?>' row_id='<?php echo esc_attr($j); ?>' >
                    <?php
                }

                elseif($j==2){
                    ?>
                    <tr class='row-price pricingtable_admin_tr_<?php echo esc_attr($j); ?>' row_id='<?php echo esc_attr($j); ?>' >
                    <?php
                }

                elseif($j==$pricingtable_total_row){
                    ?>
                    <tr class='row-signup pricingtable_admin_tr_<?php echo esc_attr($j); ?>' row_id='<?php echo esc_attr($j); ?>' >
                    <?php
                }
                    ...
                    ?>
                    <tr  class='row-data pricingtable_admin_tr_<?php echo esc_attr($j); ?>' row_id='<?php echo esc_attr($j); ?>' >
            ...
            $pricingtable_cell_header_bg_color = !empty($pricingtable_cell_header_bg_color) ? $pricingtable_cell_header_bg_color : array();
                ...
                for($i=1; $i<=$pricingtable_total_column; $i++){
                    ...
                    if($i==1 && $j==1){
                        ...
                        ?>
                        <td class='nosort pricingtable_admin_td_<?php echo esc_attr($i); ?>' column_id='<?php echo esc_attr($j); ?>-<?php echo esc_attr($i); ?>'>
                            ...
                            <div class="options">
                                <div class="option-field">
                                    ...
                                    if(!empty($pricingtable_column_featured[$i])){
                                        ?>
                                        <input class='pricingtable_column_featured' id='pricingtable_column_featured[<?php echo esc_attr($i); ?>]' name='pricingtable_column_featured[<?php echo esc_attr($i); ?>]'  size='20' type='checkbox' value='1' checked='checked'/><label title='Click to remove featured column.' for=''>Remove Featured</label>
                                        <?php
                                    }
                                    else{
                                        ?>
                                        <input class='pricingtable_column_featured' id='pricingtable_column_featured[<?php echo esc_attr($i); ?>]' name='pricingtable_column_featured[<?php echo esc_attr($i); ?>]'  size='20' type='checkbox' value='1'/><label title='Select to make featured column.' for='pricingtable_column_featured[<?php echo esc_attr($i); ?>]'>Make Featured</label>
                                        <?php
                                    }
                                    ?>
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <select name="pricingtable_column_ribbon[<?php echo esc_attr($i); ?>]" >
                                        <?php
                                        ...
                                        foreach ($ribbons_list as $ribbon_index=>$ribbon){
                                            ?>
                                            <option value="<?php echo esc_attr($ribbon_index); ?>" <?php selected($pricingtable_column_ribbon[$i], $ribbon_index ) ?> ><?php echo esc_attr($ribbon); ?></option>
                                            <?php
                                        }
                                ...
                                <div class="option-field">
                                    ...
                                    <select name="column_ribbon_position[<?php echo esc_attr($i); ?>]" >
                                ...
                                <div class="option-field">
                                    ...
                                    <input class='pricingtable_cell_header_bg_color pricingtable-color' name='pricingtable_cell_header_bg_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_header_bg_color[$i]); ?>' />
                                </div>
                                <div class="option-field">
                                    <div class="field-title">Header text color</div>
                                    <input class='pricingtable_cell_header_font_color pricingtable-color' name='pricingtable_cell_header_font_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_header_font_color[$i]); ?>' />
                                </div>


                                <div class="option-field">
                                    <div class="field-title">Header Image or Video(url)</div>
                                    <input class='pricingtable_cell_header_image' name='pricingtable_cell_header_image[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_header_image[$i]); ?>' />
                                </div>

                                <div class="option-field">
                                    <div class="field-title">Header Description Text</div>
                                    <input class='pricingtable_cell_header_description' name='pricingtable_cell_header_description[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_header_description[$i]); ?>' />
                                </div>

                                <div class="option-field">
                                    <div class="field-title">Column Width</div>
                                    <input  placeholder='250px' class='pricingtable_column_width' name='pricingtable_column_width[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_column_width[$i]); ?>' />
                                </div>

                                <div class="option-field">
                                    <div class="field-title">Column margin</div>
                                    <input  placeholder='20px' class='pricingtable_column_margin' name='pricingtable_column_margin[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_column_margin[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <input placeholder='35px'  class='pricingtable_cell_header_text_font_size' name='pricingtable_cell_header_text_font_size[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_header_text_font_size[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <select name="column_animation[<?php echo esc_attr($i); ?>]" >
                                        <?php
                                        ...
                                        foreach ($column_animation_list as $index=>$animation){
                                            ?>
                                            <option value="" <?php selected($column_animation[$i], $index ) ?> ><?php echo esc_attr($animation); ?></option>
                                            <?php
                                        }
                                    ...
                                    <input  placeholder='1000' class='column_animation_duration' name='column_animation_duration[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='' />
                    ...
                    elseif($j==1){
                        ...
                        ?>
                        <td class='pricingtable_admin_td_<?php echo esc_attr($i); ?>' column_id='<?php echo esc_attr($j); ?>-<?php echo esc_attr($i); ?>' >
                        <div title='' class='more-options'>
                            <div class="toggle"><i class="fa fa-cog" aria-hidden="true"></i></div>
                            <div class="options">
                                <div class="option-field">
                                    ...
                                    if(!empty($pricingtable_column_featured[$i])){
                                        ?>
                                        <input class='pricingtable_column_featured' id='pricingtable_column_featured[<?php echo esc_attr($i); ?>]' name='pricingtable_column_featured[<?php echo esc_attr($i); ?>]'  size='20' type='checkbox' value='1' checked='checked'/><label title='Click to remove featured column.' for='pricingtable_column_featured[<?php echo esc_attr($i); ?>]'>Remove Featured</label>
                                        <?php
                                    }
                                    else{
                                        ?>
                        ...
                        ?>
                        <td class='pricingtable_admin_td_<?php echo esc_attr($i); ?>' >
                    ...
                    if($i==1 && $j!=1)
                    {
                        ...
                        ?>
                        <span data_row='<?php echo esc_attr($j); ?>' class='pricingtable_admin_tr_remove' title='Remove this Row' ></span>
                    ...
                    if($j==1 && $i!=1 )
                    {
                        ...
                        ?>
                        <span data-column='<?php echo esc_attr($i); ?>' class='pricingtable_admin_td_remove' title='Remove this Column' ></span>
                    ...
                    if($j==1)
                    {
                        ...
                        <div class="option-field">
                            ...
                            <input name='pricingtable_cell_header_text[<?php echo esc_attr($i); ?>]' size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_header_text[$i]); ?>' />
                        </div>
                    ...
                    elseif($j==2)
                    {
                        ...
                        <div title='' class='more-options'>
                            ...
                            <div class="options">
                                ...
                                <div class="option-field">
                                    ...
                                    <input class='pricingtable_cell_price_bg_color pricingtable-color' name='pricingtable_cell_price_bg_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_price_bg_color[$i]); ?>' />
                                </div>

                                <div class="option-field">
                                    <div class="field-title">Price Text Color</div>
                                    <input class='pricingtable_cell_price_font_color pricingtable-color' name='pricingtable_cell_price_font_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_price_font_color[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <input placeholder='Pre Month' class='pricingtable_cell_price_duration' name='pricingtable_cell_price_duration[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_price_duration[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <input placeholder='35px' class='pricingtable_cell_price_font_size' name='pricingtable_cell_price_font_size[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_price_font_size[$i]); ?>' />
                                </div>
                        ...
                        <div class="option-field">
                            ...
                            <input placeholder='$20' name='pricingtable_cell_price[<?php echo esc_attr($i); ?>]' data_cell='"<?php echo esc_attr($j.$i); ?>' size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_price[$i]); ?>' />
                        </div>
                    ...
                    elseif($j==$pricingtable_total_row)
                    {
                        ...
                        <div title='' class='more-options'>
                            ...
                            <div class="options">
                                ...
                                <div class="option-field">
                                    ...
                                    <input class='pricingtable_cell_signup_bg_color pricingtable-color' name='pricingtable_cell_signup_bg_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_signup_bg_color[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <input class='pricingtable_cell_signup_button_bg_color pricingtable-color' name='pricingtable_cell_signup_button_bg_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_signup_button_bg_color[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <input class='signup_button_font_color pricingtable-color' name='signup_button_font_color[<?php echo esc_attr($i); ?>]'  size='20' type='text' value='<?php echo esc_attr($signup_button_font_color[$i]); ?>' />
                                </div>
                                ...
                                <div class="option-field">
                                    ...
                                    <select name="signup_button_style[<?php echo esc_attr($i); ?>]">
                                        <?php
                                        foreach ($signup_button_style_list as $style_index=>$style){
                                            ?>
                                            <option <?php if(isset($signup_button_style[$i]) && $signup_button_style[$i]==$style_index) echo 'selected'; ?>  value="<?php echo esc_attr($style_index); ?>"><?php echo esc_html($style); ?></option>
                                            <?php
                                        }
                                        ?>
                        ...
                        <div class="option-field">
                            ...
                            <input placeholder='SignUp' name='pricingtable_cell_signup_name[<?php echo esc_attr($i); ?>]' data_cell='<?php echo esc_attr($j.$i); ?>' size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_signup_name[$i]); ?>' />
                        </div>

                        <div class="option-field">
                            <div class="field-title">SignUp URL</div>
                            <input placeholder='http://example.com' name='pricingtable_cell_signup_url[<?php echo esc_attr($i); ?>]' data_cell='<?php echo esc_attr($j.$i); ?>' size='20' type='text' value='<?php echo esc_attr($pricingtable_cell_signup_url[$i]); ?>' />
                        </div>
                    ...
                    else
                    {
                        ...
                        <div class="option-field">
                            ...
                            <input name='pricingtable_cell[<?php echo esc_attr($j.$i); ?>]' data_cell='<?php echo esc_attr($j.$i); ?>' size='20' type='text' value='<?php echo esc_attr($pricingtable_cell[$j.$i]); ?>' />
                        </div>
...
function pricingtable_metabox_content_style($post_id){
    ...
    <div class="section">
            ...
            foreach ($column_item_position_list as $item_index=>$item){
                ...
                <div class="item">
                    <div class="header">
                        ...
                        <span class=""> <?php echo esc_html($name); ?></span>
                    </div>

                    <div class="options">

                        <input type="text" name="column_item_position[<?php echo esc_attr($item_index); ?>][name]" value="<?php echo esc_attr($name); ?>">
                        <p>Hide this item?</p>
                        <select name="column_item_position[<?php echo esc_attr($item_index); ?>][is_hide]">
            ...
            foreach ($pricingtable_themes_list as $theme_index=>$theme_data){
                ...
                <label>
                    ...
                    if($theme_index=='flat' || $theme_index=='rounded' || $theme_index=='semi-rounded'){
                        ?>
                        <input type="radio" name="pricingtable_themes" <?php if($pricingtable_themes==$theme_index) echo "checked"; ?>  value="<?php echo esc_attr($theme_index); ?>">
                        <?php
                    ...
                    <img style="width: 100px;height: auto" src="<?php echo esc_url(pricingtable_plugin_url.'templates/themes/'.$theme_index.'/images/screenshot.png'); ?>">
                    <div class="screenshot">
                        ...
                        <img style="width: 100%;height: auto" src="<?php echo esc_url(pricingtable_plugin_url.'templates/themes/'.$theme_index.'/images/screenshot.png'); ?>"></div>
                </label>
                <?php
            }
            ?>
        ...
        while($i<$count)
        {
            ...
            {
                echo "<li class='bg-selected' data-url='".esc_url($filelink)."'>";
            }
            else
            {
                echo "<li data-url='".esc_url($filelink)."'>";
            }


            echo "<img  width='70px' height='50px' src='".esc_url($filelink)."' />";
            echo "</li>";
            $i++;
        }
        ...
        echo "<input style='width:70%;' value='".esc_attr($pricingtable_bg_img)."'    placeholder='Please select image or left blank' id='pricingtable_bg_img' name='pricingtable_bg_img'  type='text' />";
...
function post_meta_save_pricingtable($post_id){
    ...
    $pricingtable_hide_empty_row = isset($_POST['pricingtable_hide_empty_row']) ? sanitize_text_field( wp_unslash($_POST['pricingtable_hide_empty_row']) ) : '';
    //$pricingtable_hover_effect = sanitize_text_field( $_POST['pricingtable_hover_effect'] );
    $pricingtable_bg_img = isset($_POST['pricingtable_bg_img']) ? sanitize_text_field( wp_unslash($_POST['pricingtable_bg_img']) ) : '';
    $pricingtable_themes =  isset($_POST['pricingtable_themes']) ? sanitize_text_field( wp_unslash($_POST['pricingtable_themes']) ) : 'flat';
    $column_item_position = pricingtable_recursive_sanitize_arr( wp_unslash($_POST['column_item_position']) );

    $pricingtable_total_row = isset($_POST['pricingtable_total_row']) ? sanitize_text_field( wp_unslash($_POST['pricingtable_total_row']) ) : '';
    $pricingtable_total_column = isset($_POST['pricingtable_total_column']) ? sanitize_text_field( wp_unslash($_POST['pricingtable_total_column']) ) : '';
    $pricingtable_cell = isset($_POST['pricingtable_cell']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell']) ) : '';

    $pricingtable_column_width = isset($_POST['pricingtable_column_width']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_column_width']) ) : '';
    $pricingtable_column_margin = isset($_POST['pricingtable_column_margin']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_column_margin']) ) : '';


    $pricingtable_column_featured = isset($_POST['pricingtable_column_featured']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_column_featured']) ) : '';
    $pricingtable_column_ribbon = isset($_POST['pricingtable_column_ribbon']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_column_ribbon']) ) : '';
    $column_ribbon_position = isset($_POST['column_ribbon_position']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['column_ribbon_position']) ) : '';

    $pricingtable_cell_price_duration = isset($_POST['pricingtable_cell_price_duration']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_price_duration']) ) : '';
    $pricingtable_cell_price = isset($_POST['pricingtable_cell_price']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_price']) ) : '';
    $pricingtable_cell_price_bg_color = isset($_POST['pricingtable_cell_price_bg_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_price_bg_color']) ) : '';
    $pricingtable_cell_price_font_color = isset($_POST['pricingtable_cell_price_font_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_price_font_color']) ) : '';
    $pricingtable_cell_price_font_size = isset($_POST['pricingtable_cell_price_font_size']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_price_font_size']) ) : '';

    $pricingtable_cell_signup_bg_color = isset($_POST['pricingtable_cell_signup_bg_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_signup_bg_color']) ) : '';
    $pricingtable_cell_signup_button_bg_color = isset($_POST['pricingtable_cell_signup_button_bg_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_signup_button_bg_color']) ) : '';
    $signup_button_font_color = isset($_POST['signup_button_font_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['signup_button_font_color']) ) : '';

    $signup_button_style = isset($_POST['signup_button_style']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['signup_button_style']) ) : '';


    $pricingtable_cell_signup_name = isset($_POST['pricingtable_cell_signup_name']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_signup_name']) ) : '';
    $pricingtable_cell_signup_url = isset($_POST['pricingtable_cell_signup_url']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_signup_url']) ) : '';


    $pricingtable_cell_header_description = isset($_POST['pricingtable_cell_header_description']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_header_description']) ) : '';
    $pricingtable_cell_header_image = isset($_POST['pricingtable_cell_header_image']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_header_image']) ) : '';
    $pricingtable_cell_header_bg_color = isset($_POST['pricingtable_cell_header_bg_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_header_bg_color']) ) : '';
    $pricingtable_cell_header_font_color = isset($_POST['pricingtable_cell_header_font_color']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_header_font_color']) ) : '';
    $pricingtable_cell_header_text = isset($_POST['pricingtable_cell_header_text']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_header_text']) ) : '';
    $pricingtable_cell_header_text_font_size = isset($_POST['pricingtable_cell_header_text_font_size']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_cell_header_text_font_size']) ) : '';
    $column_animation = isset($_POST['column_animation']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['column_animation']) ) : '';
    $column_animation_duration = isset($_POST['column_animation_duration']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['column_animation_duration']) ) : '';

    $pricingtable_row_bg_odd = isset($_POST['pricingtable_row_bg_odd']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_row_bg_odd']) ) : '';
    $pricingtable_row_bg_even = isset($_POST['pricingtable_row_bg_even']) ? pricingtable_recursive_sanitize_arr( wp_unslash($_POST['pricingtable_row_bg_even']) ) : '';
    $mobile_enable_slider = isset($_POST['mobile_enable_slider']) ? sanitize_text_field( wp_unslash($_POST['mobile_enable_slider']) ) : '';
